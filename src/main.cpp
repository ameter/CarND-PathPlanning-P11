    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Get two starting points based on end of previous path or car's position and yaw
          if(prev_size < 2) {
            // previous path is almost empty, use the car as starting reference
          ...
          for (int i = 0; i < ptsx.size(); i++) {
            // shift car referece angle to 0 degrees
